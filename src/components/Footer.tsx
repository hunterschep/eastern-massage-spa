        ...
        <footer className="bg-primary text-primary-foreground py-12 text-sm border-t border-primary/20">
            <div className="container mx-auto px-4 flex flex-col md:flex-row justify-between items-center gap-6">
                <div className="text-center md:text-left">
                    <span className="text-lg font-serif font-bold text-secondary block mb-2">Eastern Massage Spa</span>
                    <p className="text-primary-foreground/60">&copy; {new Date().getFullYear()} Eastern Massage Spa. All rights reserved.</p>
                </div>
